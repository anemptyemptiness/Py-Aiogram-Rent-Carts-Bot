...
class AlbumsMiddleware(BaseMiddleware):
    ...
    async def __call__(
        ...
        if str(await data["state"].get_state()).split(":")[-1] == "employee_photo":
        ...
        # обрабатывается ситуация, когда человек прислал несколько фотографий рабочей точки
        ...
        # обрабатывается ситуация, когда человек прислал несколько фотографий дефектов тележек
        ...
        # обрабатывается ситуация, когда человек прислал несколько фотографий чеков закрытия смены
